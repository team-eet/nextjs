...
const BatchDetailsOne = ({ checkMatchCourses, getFname, getLname }) => {
                ...
                <div className="course-details-content">
                    ...
                    >
                        {checkMatchCourses &&
                            ...
                            <Instructor getFName={getFname} getLName={getLname} checkMatchCourses={checkMatchCourses} />
                        }
                    </div>
                    <div
...
export default BatchDetailsOne;
