...
const CourseBreadcrumb = ({ getMatchCourse, getName1, getName2, getstdcnt }) => {
            ...
            <div className="rbt-avater">
              ...
              <Link href={``}>
                {getMatchCourse.tutor_image && (
                    <Image src={getMatchCourse.tutor_image} className={"position-relative"}  width={40} height={40}></Image>
                  // <Image
                  //   width={40}
                  //   height={40}
