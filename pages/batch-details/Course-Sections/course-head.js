...
const CourseHead = ({ checkMatch, getstdcnt, getFname, getLname }) => {
    ...
    <>
      {path === "/course-details-2/[courseId]" ? (
        ...
        <>
          ...
          <div className="container">
            <div className="row">
              <CourseBreadcrumb getstdcnt={getstdcnt} getName1={getFname} getName2={getLname} getMatchCourse={checkMatch && checkMatch} />
            </div>
          </div>
        </>
      )}
